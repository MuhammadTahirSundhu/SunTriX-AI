      ...
      switch (event.type) {
        ...
        case "payment_intent.succeeded": {
          ...
          if (sessions.data.length > 0) {
            ...
            const invoiceToken = sessions.data[0].metadata?.invoiceToken;
            const trackingToken = sessions.data[0].metadata?.trackingToken || "";
            let updated: any = null;
            ...
            console.log(`[Webhook] payment_intent.succeeded → DB:`, updated ? `✅ _id=${updated._id}` : "❌ NO MATCH");

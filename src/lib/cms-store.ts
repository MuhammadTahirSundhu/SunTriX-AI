...
const SEED_DEPARTMENTS: Omit<Department, "id" | "updatedAt">[] = [
  ...
  {
    name: "SunTriX Platform",
    subtitle: "AI Product & SaaS Development",
    description: "End-to-end SaaS platform engineering with multi-tenant architecture, API-first design, embedded AI, and scalable cloud infrastructure.",
    image: "",

  ...
  return (
    <Layout>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
            <span className="inline-block text-xs font-mono text-primary uppercase tracking-widest mb-4">About SunTriX</span>
      ...
      <section className="py-24 bg-card/30 border-t border-border">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="text-3xl font-extrabold mb-12 text-center">Our <span className="gradient-text">Values</span></h2>
      ...
      <section className="py-24 border-t border-border">
        <div className="container mx-auto px-4 lg:px-8">
          <h2 className="text-3xl font-extrabold mb-12 text-center">Leadership <span className="gradient-text">Team</span></h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {team.map((member, i) => (
